...
public class SpannableTextview extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_spannable_textview);
        findViews ();
    }
    ...
    class MyClickableSpan extends ClickableSpan {
        ...
        public void onClick(View tv)
        {
            ...
            Toast.makeText (SpannableTextview.this, "Thanks for the click!", Toast.LENGTH_SHORT).show ();
        }
